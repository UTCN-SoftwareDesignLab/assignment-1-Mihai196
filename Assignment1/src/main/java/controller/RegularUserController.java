...
public class RegularUserController {
	...
	private class RemoveAccountButtonListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			JOptionPane.showMessageDialog(null, "Account with id "+id+" was deleted succesfully from the database");
			}
			catch(Exception e)
			{
				e.printStackTrace();
				JOptionPane.showMessageDialog(null, "An error occured when trying to delete the account. Make sure you use the right types for id");
			}
	...
	private class AddAccountButtonListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			JOptionPane.showMessageDialog(null, "Account for client with id"+clientId+"was added succesfully to the database");
			}
			catch(Exception e)
			{
				e.printStackTrace();
				JOptionPane.showMessageDialog(null, "An error occured when trying to add the account. Make sure you use the right type for fields");
			}
	...
	private class RemoveClientButtonListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			JOptionPane.showMessageDialog(null, "Client with the Id " + id + "was deleted succesfully from the database");
			}
			catch (Exception e)
			{
				e.printStackTrace();
